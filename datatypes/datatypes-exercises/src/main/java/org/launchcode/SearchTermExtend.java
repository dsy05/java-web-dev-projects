...
public class SearchTermExtend {
    public static void main(String[] args) {
        ...
        String firstSentenceWordRemoved = firstSentence.replace(searchTerm, "");
        System.out.println("Search Term: " + searchTerm);
        System.out.println("Search Term Found In Passage: " + firstSentence.contains(searchTerm));
        System.out.println("Search Term Index: " + firstSentence.indexOf(searchTerm));
        System.out.println("Search Term Length: " + searchTerm.length());
        System.out.println("Modified Sentence: " + firstSentenceWordRemoved);
    }
}
